...
describe('useSchoolStore — people', () => {
  describe('fetchStudents', () => {
    it('calls GET /students and stores array result', async () => {
      ...
      expect(getSpy).toHaveBeenCalledWith('/students', { params: undefined });
    ...
    it('handles paginated response with data wrapper', async () => {
      ...
      expect(api.get).toHaveBeenCalledWith('/students', { params: { class: 'Class 2' } });
    ...
    it('passes params correctly', async () => {
      ...
      expect(api.get).toHaveBeenCalledWith('/students', { params: { class: 'Class 1', session: '2025' } });
    });
  ...
  describe('fetchTeachers', () => {
    it('calls GET /teachers and stores array result', async () => {
      ...
      expect(getSpy).toHaveBeenCalledWith('/teachers', { params: undefined });
    ...
    it('handles paginated response', async () => {
      ...
      expect(api.get).toHaveBeenCalledWith('/teachers', { params: { designation: 'head' } });
      expect(useSchoolStore.getState().teachers).toEqual(teacherList);
  ...
  describe('fetchStaff', () => {
    it('calls GET /staff and stores array result', async () => {
      ...
      expect(getSpy).toHaveBeenCalledWith('/staff', { params: undefined });
    ...
    it('handles paginated response', async () => {
      ...
      expect(api.get).toHaveBeenCalledWith('/staff', { params: { designation: 'cleaner' } });
      expect(useSchoolStore.getState().staff).toEqual(staffList);
